...
10. 플레이어는 트랩에 닿을 시 사망한다.  
11. 난이도 상승에 따라 몬스터와 보스가 등장한다.  
12. 몬스터는 이동하고 공격하지만 캐릭터가 몬스터를 처치하는건 불가능하며 회피해야 한다.  
13. 보스는 매 스테이지 후반부 보스룸으로 입장하는 포탈을 통해 이동시 등장한다.  
14. 보스의 체력은 중앙 상단에 체력바로 확인 가능하다.  
15. 각 스테이지 보스별 공격 패턴은 재도전해도 일치하다.  
