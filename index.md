...
3-2) 플레이어는 트랩에 닿을 시 사망한다. (10) - 서윤성

3-3) 게임화면 우측 상단에 현재 스테이지의 정보 텍스트가 출력된다. (24) - 박기현

3-4) 사운드바, 조작법 설명, 재시작 설명 화면 UI를 정하고 구현한다. (3, 5, 7) - 서윤성
...
6-1) 보스의 패턴공격1과 2는 정해진 패턴에 따라 공격을 반복한다. (33) - 박기현

6-2) 보스의 랜덤공격은 일정한 패턴 없이 무작위로 공격한다. (34) - 서윤성

6-3) 보스의 기본공격은 보스가 플레이어 방향으로 근접 혹은 원거리로 공격한다. (32) - 서윤성
